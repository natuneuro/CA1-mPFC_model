...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca /run/media/natalia/Naty SSD/DOCTORADO/CODIGOS/Math_model/CA1_mPFC_TC-main/sim/mod_minimal/Ca.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/run/media/natalia/Naty SSD/DOCTORADO/CODIGOS/Math_model/CA1_mPFC_TC-main/sim/mod_minimal/Ca.mod";
static const char* nmodl_file_text = 
  ":Comment :\n"
