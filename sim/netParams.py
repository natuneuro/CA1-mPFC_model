...
if cfg.connect_ThVecStim_S1:
    ...
    for line in mtype_content.split('\n')[:-1]:
        ...
        convergence_Th_S1['VPL_sTC'][mtype] = int(int(preFO)) # First Order  
        convergence_Th_S1['VPM_sTC'][mtype] = int(int(preFO)) # First Order
        convergence_Th_S1['POm_sTC_s1'][mtype] = int(int(preHO)) # High Order 
